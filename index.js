...
app.get('/images/544750.jpg', (req, res) => {
    res.sendFile(__dirname + '/images/544750.jpg');
});
app.get('/images/014.jpg', (req, res) => {
    res.sendFile(__dirname + '/images/014.jpg');
});
app.get('/images/015.jpg', (req, res) => {
    res.sendFile(__dirname + '/images/015.jpg');
});
